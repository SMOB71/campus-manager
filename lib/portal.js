...
export const PORTAL_KINDS = ["learner", "teacher", "tutor"];
export const KIND_LABEL = { learner: "Apprenant", teacher: "Formateur", tutor: "Tuteur entreprise" };
...
export const DEFAULT_TTL_DAYS = { learner: 365, teacher: 365, tutor: 400 };
