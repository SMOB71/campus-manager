...
// l'action de formation. C'est elle que le financeur contrôle. Une feuille
// modifiable après coup sans trace ne vaut rien devant un contrôle.
//
// ⚠️ CE QU'ELLE NE FAIT PAS : en ALTERNANCE, elle ne détermine PAS le montant.
// Le NPEC se verse au prorata des jours de CONTRAT exécutés, pas de l'assiduité —
// l'émargement sert la preuve et le contrôle, pas le calcul. Ce n'est qu'en
// formation CONVENTIONNÉE (CPF, plan) que l'heure réalisée se facture. Voir
// lib/billing.js : confondre les deux produit des factures fausses.
//
