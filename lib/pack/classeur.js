...
export async function classeurPilotage(projet, plan, ch) {
  ...
  // ── 3. Actions — le cœur ──────────────────────────────────────────────────
  {
    ...
    h.titre(ws, "Suivi des actions", "Colonnes encadrées en couleur = à vous. Les autres se calculent — les écraser casse la propagation.", 23);
    h.entetes(ws, 4, ["Id", "Code", "Chantier", "Action", "Responsable", "Jalon ?", "Critique ?",
      ...
      "Budget dépensé", "Bloquée par", "Direction", "Après la rentrée ?", "Date imposée par"],
      [10, 9, 24, 52, 20, 8, 9, 12, 12, 8, 11, 14, 13, 12, 11, 12, 11, 13, 13, 26, 14, 15, 34]);
