...
const DEPT_MOTIFS = [
  ...
  [/\brectorat\b|\brecteur\b|\bUAI\b|\bDOKELIO\b|Qualiopi|\bNDA\b|\bCFA\b|certificateur|\bjurys?\b|épreuves|positionnement|handicap|mobilité|référentiel BTS|Dimensionnement du plateau|Pré-rentrée|bilan pédagogique|délai d'opposition/i, "academique"],
...
// d'organisation mais des délais subis — trois mois d'opposition du recteur (art. L.441-1
// du code de l'éducation), instruction du Cerfa ERP, durée de chantier, délai fournisseur,
// visite de la commission de sécurité. Les comprimer produirait un plan infaisable qui
// aurait l'air valide.
//
// On ne comprime donc QUE l'amont — étude, décision, recherche du local, négociation du
// bail — et on laisse la chaîne contrainte intacte. Le pivot est la déclaration
// d'ouverture au recteur : c'est la première échéance à date opposable.
export const OPENING_DUREE_REF = 15;
export const OPENING_PIVOT = 10.5;
// En dessous de ce plancher, l'amont ne tient plus : trouver un local, le négocier et le
// sécuriser en moins de six semaines suppose un local déjà identifié.
export const OPENING_AMONT_MIN = 1.5;

export function recalibrer(m, duree = OPENING_DUREE_REF) {
  if (!(duree > 0) || duree >= OPENING_DUREE_REF || m <= OPENING_PIVOT) return m;
  const ref = OPENING_DUREE_REF - OPENING_PIVOT;                       // 4,5 mois d'amont
...
// Durée minimale tenable : la chaîne contrainte plus le plancher d'amont.
export const OPENING_DUREE_MIN = OPENING_PIVOT + OPENING_AMONT_MIN;
...
export const OPENING_TEMPLATE = [
  ...
  { lot: "immo", title: "Cahier des charges des locaux (surface, zone, ERP)", m: 13 , key: "cdc-locaux", after: ["gonogo"] },
  { lot: "immo", title: "Recherche & visites de locaux", m: 12, critical: true , key: "recherche-locaux", after: ["cdc-locaux"] },
  { lot: "immo", title: "Diagnostics techniques du bâtiment (amiante, plomb, structure, DPE)", m: 11.5, critical: true , key: "diagnostics", after: ["recherche-locaux"] },
  { lot: "immo", title: "Diagnostic d'accessibilité préalable du local", m: 11.5, critical: true , key: "diag-access", after: ["recherche-locaux"] },
  { lot: "immo", title: "Puissance électrique disponible pour l'atelier et les machines", m: 11.5, critical: true , key: "puissance-elec", after: ["recherche-locaux"] },
  ...
  { lot: "immo", title: "Signature du bail", m: 9, critical: true , key: "signature-bail", after: ["cond-susp", "autorisation-erp", "financement"] },
  ...
  { lot: "immo", title: "Classement ERP : type R et catégorie selon l'effectif", m: 12, critical: true , key: "classement-erp", after: ["cdc-locaux"] },
  { lot: "immo", title: "Autorisation de travaux ERP (Cerfa) : notice de sécurité + notice d'accessibilité", m: 9.5, critical: true , key: "autorisation-erp", after: ["classement-erp", "diag-access", "plan-amenagement"] },
  { lot: "immo", title: "Avis de la commission d'accessibilité", m: 8 , key: "avis-access", after: ["autorisation-erp"] },
  ...
  { lot: "immo", title: "Demande de visite de la commission de sécurité (1 mois avant, 2 mois en 1re catégorie)", m: 2.5, critical: true , key: "demande-visite", after: ["verifs-tech"] },
  { lot: "immo", title: "Passage de la commission de sécurité & levée des réserves", m: 1.5, critical: true , key: "passage-commission", after: ["demande-visite"] },
  { lot: "immo", title: "ARRÊTÉ D'OUVERTURE DU MAIRE — sans lui, pas d'accueil du public", m: 1, critical: true , key: "arrete-maire", after: ["passage-commission"] },
  ...
  // Plans
  { lot: "travaux", title: "Relevé de l'existant & plans de l'état des lieux", m: 10.5, key: "releve", after: ["negoc-bail"] },
  { lot: "travaux", title: "Plan d'aménagement : salles, atelier, administratif, espaces communs", m: 10, critical: true , key: "plan-amenagement", after: ["releve"] },
  ...
  { lot: "travaux", title: "Comparatif des devis & sélection des entreprises", m: 6, critical: true , key: "devis", after: ["appel-offres"] },
  ...
  { lot: "travaux", title: "Démarrage du chantier & second œuvre", m: 6, critical: true , key: "demarrage-chantier", after: ["devis", "autorisation-erp", "edl-entree"] },
  ...
  { lot: "admin", title: "Déclaration d'ouverture au recteur — délai d'opposition de 3 mois (maire, préfet, procureur)", m: 10.5, critical: true , key: "decl-recteur", after: ["siret", "negoc-bail"] },
  { lot: "admin", title: "Expiration du délai d'opposition — ouverture juridiquement possible", m: 7.5, critical: true , key: "expiration-opposition", after: ["decl-recteur"] },
  ...
  { lot: "admin", title: "Demande de numéro UAI", m: 10, key: "uai" },
  ...
  { lot: "admin", title: "Référencement DOKELIO : saisie de l'offre dans la base nationale", m: 10.5, critical: true , key: "dokelio", after: ["rncp"] },
  ...
  { lot: "admin", title: "NDA — déclaration d'activité auprès de la DREETS (préalable à Qualiopi)", m: 8, critical: true , key: "nda", after: ["siret"] },
  ...
  { lot: "rh", title: "Recrutement du directeur de campus", m: 10, critical: true , key: "recrut-directeur", after: ["fiches-poste"] },
  { lot: "rh", title: "Recrutement de l'équipe pédagogique", m: 6, critical: true , key: "recrut-pedago", after: ["recrut-directeur", "habilitation"] },
  { lot: "rh", title: "Recrutement administratif & admissions", m: 5 , key: "recrut-admin", after: ["recrut-directeur"] },
  { lot: "rh", title: "Sourcing vacataires & intervenants pro", m: 4 },
  { lot: "rh", title: "Contrats de travail, DPAE & registre unique du personnel", m: 2, critical: true , key: "contrats-travail", after: ["recrut-pedago", "recrut-admin"] },
  ...
  { lot: "marketing", title: "Site / landing page du campus", m: 9 , key: "site", after: ["identite", "filieres"] },
  { lot: "marketing", title: "Plan média & campagnes d'acquisition", m: 8, critical: true , key: "plan-media", after: ["site", "rncp"] },
  { lot: "marketing", title: "Dossier Parcoursup — calendrier contraint, dépôt à date fixe", m: 10, critical: true , key: "parcoursup", after: ["rncp", "decl-recteur", "dokelio"] },
  ...
  { lot: "marketing", title: "Conventions avec les enseignes (alternance, taxe d'apprentissage)", m: 9, critical: true , key: "conventions-enseignes", after: ["recensement-magasins"] },
  ...
  { lot: "marketing", title: "Journées Portes Ouvertes (série)", m: 5, critical: true , key: "jpo", after: ["plan-media", "site"] },
  { lot: "marketing", title: "Objectif de recrutement & suivi du pipeline", m: 8, critical: true , key: "objectif-recrut", after: ["bp", "plan-media"] },
  { lot: "lancement", title: "Pré-rentrée (accueil, EDT, comptes, badges)", m: 0.5, critical: true , key: "prerentree", after: ["arrete-maire", "livraison-optique", "livraison-mobilier", "contrats-travail", "mise-service-info", "edt", "comptes", "expiration-opposition", "qualiopi-audit"] },
...
export function buildOpeningTasks(targetDate, settings = {}, duree = OPENING_DUREE_REF) {
  ...
  for (const [idx, t] of OPENING_TEMPLATE.entries()) {
    ...
    const m = lead && semaines > 0 ? t.needM + semaines / SEM : recalibrer(t.m, duree);
