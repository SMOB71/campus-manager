...
export const OPENING_TEMPLATE = [
  ...
  { lot: "travaux", title: "COMMANDE postes de réfraction (réfracteurs, projecteurs de tests, fauteuils)", m: 6, critical: true },
  { lot: "travaux", title: "COMMANDE instruments d'examen (lampes à fente, kératomètre, autoréfractomètre)", m: 6, critical: true },
  { lot: "travaux", title: "COMMANDE frontofocomètres & matériel de contrôle", m: 6, critical: true },
  { lot: "travaux", title: "COMMANDE matériel de contactologie & consommables associés", m: 5, critical: true },
