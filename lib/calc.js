...
const DEPT_MOTIFS = [
  [/Parcoursup|Journées Portes Ouvertes|CRM admissions|Objectif de recrutement|Recensement des magasins|Conventions avec les enseignes|Lycées & CIO|salons & référencement|Onisep|Argumentaire commercial|remises, bourses|Campagne employeurs|équipe commerciale|techniques d'admission/i, "commerce"],
  ...
  [/\brectorat\b|\brecteur\b|\bUAI\b|\bDOKELIO\b|Qualiopi|\bNDA\b|\bCFA\b|certificateur|\bjurys?\b|épreuves|positionnement|handicap|mobilité/i, "academique"],
  [/Business plan|Assurances|Souscription des assurances/i, "finance"],
];
