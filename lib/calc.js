...
export const OPENING_JALONS = new Set([
  ...
  "signature-bail", "autorisation-erp",                        // le lieu et le droit d'y toucher
  "filieres", "rncp",                                          // ce qu'on enseigne
  "demande-rectorat", "depot-rectorat", "pieces-rectorat", "autorisation-prefecture",
  "uai", "carif-oref", "nda", "qualiopi-audit", "parcoursup",  // ouverture administrative
  "presentation-directeur", "presentation-formateurs",         // ce que le terrain doit recevoir
  "recrut-directeur", "recrut-pedago", "contrats-travail",     // les gens
...
// Durée minimale tenable : la chaîne subie plus le plancher d'amont.
...
export const OPENING_TEMPLATE = [
  ...
  { lot: "admin", title: "Demande du dossier d'ouverture au rectorat concerné, dès le lancement — le process diffère d'un rectorat à l'autre", m: 15, critical: true, key: "demande-rectorat" },
  { lot: "admin", title: "Dépôt du dossier d'ouverture au rectorat (formalité d'enregistrement)", m: 11, key: "depot-rectorat", after: ["siret", "demande-rectorat"] },
  ...
  { lot: "offre", title: "Présentation des programmes et de l'organisation académique au directeur de campus — avec le PRN et le responsable pédagogique initiale France", m: 4.5, critical: true, key: "presentation-directeur", after: ["recrut-directeur", "filieres"] },
  ...
  { lot: "marketing", title: "Dossier Parcoursup — calendrier contraint, dépôt à date fixe", m: 10, critical: true , key: "parcoursup", after: ["carif-oref"] },
