...
const DEPT_MOTIFS = [
  [/Parcoursup|Journées Portes Ouvertes|CRM admissions|Objectif de recrutement|Recensement des magasins|Conventions avec les enseignes|Lycées & CIO|salons & référencement|Onisep/i, "commerce"],
  [/rectorat|recteur|UAI|Qualiopi|NDA|CFA|certificateur|jury|épreuves|positionnement|handicap|mobilité/i, "academique"],
...
export const OPENING_TEMPLATE = [
  ...
  { lot: "marketing", title: "Dossier Parcoursup — calendrier contraint, dépôt à date fixe", m: 10, critical: true , key: "parcoursup", after: ["rncp", "decl-recteur"] },
