...
export const OPENING_TEMPLATE = [
  ...
  { lot: "immo", title: "DÉPÔT du dossier d'autorisation de travaux ERP (Cerfa 13824) : notice de sécurité + notice d'accessibilité", m: 13.4, critical: true, key: "depot-at-erp", after: ["classement-erp", "diag-access", "plan-amenagement"] },
  { lot: "immo", title: "Autorisation de travaux ERP obtenue — instruction de QUATRE MOIS à compter du dossier complet, silence valant accord", m: 6.1, critical: true , key: "autorisation-erp", after: ["depot-at-erp", "avis-access"] },
  ...
  { lot: "immo", title: "Souscription des assurances : dommages-ouvrage OBLIGATOIRE avant l'ouverture du chantier (art. L242-1), multirisque, RC", m: 6.3, critical: true, key: "souscription-assur", after: ["devis"] },
  ...
  { lot: "admin", title: "Fin du délai d'opposition de trois mois (recteur, maire, préfet, procureur) — l'ouverture n'est acquise qu'à ce terme", m: 6, critical: true, key: "fin-opposition", after: ["depot-rectorat"] },
  ...
  { lot: "admin", title: "NDA — déclaration d'activité à la DREETS : dans les 3 mois suivant la 1re convention signée, récépissé sous 30 jours (préalable à Qualiopi)", m: 8, critical: true , key: "nda", after: ["siret"] },
  ...
  { lot: "rh", title: "DPAE — au plus tôt 8 jours avant la prise de poste, au plus tard la veille (une DPAE anticipée est irrecevable)", m: 0.6, fixe: true, critical: true, key: "dpae", after: ["contrats-travail"] },
  ...
  { lot: "marketing", title: "Dossier Parcoursup remonté au rectorat — la carte des formations ouvre à la mi-décembre et le dossier suppose l'UAI : si l'UAI arrive en décembre, la 1re promotion se recrute en admission directe", m: 9.7, critical: true , key: "parcoursup", after: ["uai", "carif-oref"] },
