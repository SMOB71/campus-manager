...
// Commande → livraison, c'est le délai fournisseur ; consultation → sélection des
// entreprises, la durée de l'appel d'offres ; demande de visite → passage de la
// commission, un mois de convocation ; démarrage → achèvement, la durée des travaux. Les
