...
export const QUALIOPI_GLOSSARY = [
  { t: "Qualiopi", d: "Marque de certification qualité, obligatoire depuis le 1er janvier 2022 pour accéder aux fonds publics et mutualisés (CPF, OPCO, État, Régions, France Travail). Sans elle, pas de financement de ces prestations." },
  ...
  { t: "CPF (Compte Personnel de Formation)", d: "Droit à la formation crédité en euros pour chaque actif, mobilisable via Mon Compte Formation. Ne finance que des formations certifiantes portées par un organisme certifié Qualiopi." },
