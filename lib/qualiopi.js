...
// `p` = périmètre : catégories d'actions concernées. Un indicateur hors périmètre
// n'est pas « non conforme », il est SANS OBJET — les confondre fait chuter un
// taux de conformité sans raison.
//   af = actions de formation · app = apprentissage · bc = bilans de compétences · vae
const TOUS = ["af", "app", "bc", "vae"];
export const QUALIOPI_V2026 = [
  { c: 1, titre: "Information du public", indicators: [
    { n: 1, l: "Information accessible au public : prestations, prérequis, objectifs, durée, modalités", p: TOUS },
    { n: 2, l: "Indicateurs de résultats adaptés à la nature des prestations et des publics", p: TOUS },
    // Exigence détachée et renforcée : ce n'est plus un sous-ensemble de l'info
    // générale, c'est un indicateur à part entière.
    { n: 3, l: "Taux d'obtention des certifications, équivalences, passerelles et débouchés", p: ["af", "app", "bc"] },
  ]},
  { c: 2, titre: "Objectifs et adaptation des prestations", indicators: [
    { n: 4, l: "Analyse du besoin du bénéficiaire, avec l'entreprise et/ou le financeur", p: TOUS },
    { n: 5, l: "Objectifs opérationnels et évaluables de la prestation", p: TOUS },
    { n: 6, l: "Contenus et modalités adaptés aux objectifs définis et aux publics", p: TOUS },
    { n: 7, l: "Adéquation des contenus à la certification visée et capacité à l'assurer", p: ["af", "app", "bc"] },
    { n: 8, l: "Procédures de positionnement et d'évaluation des acquis à l'entrée", p: TOUS },
  ]},
  { c: 3, titre: "Adaptation aux publics, accueil, accompagnement, suivi", indicators: [
    { n: 9, l: "Information des bénéficiaires sur les conditions de déroulement", p: TOUS },
    { n: 10, l: "Mise en œuvre, adaptation, accompagnement et suivi adaptés aux publics", p: TOUS },
    { n: 11, l: "Évaluation de l'atteinte des objectifs par les bénéficiaires", p: TOUS },
    ...
    { n: 12, l: "Prévention des ruptures, des violences, du harcèlement et des discriminations", p: TOUS },
    { n: 13, l: "Anticipation des missions confiées et coordination centre / entreprise", p: ["app"] },
    { n: 14, l: "Accompagnement socio-professionnel et traitement des ruptures sans délai", p: ["app"] },
    { n: 15, l: "Information des apprentis : droits et devoirs, santé-sécurité, violences, harcèlement", p: ["app"] },
    { n: 16, l: "Conditions de présentation à la certification conformes aux exigences de l'autorité", p: ["af", "app", "bc"] },
  ]},
  { c: 4, titre: "Moyens pédagogiques, techniques et d'encadrement", indicators: [
    { n: 17, l: "Moyens humains et techniques adaptés, environnement approprié", p: TOUS },
    { n: 18, l: "Mobilisation et coordination des intervenants internes et/ou externes", p: TOUS },
    // Le distanciel ne suffit plus à être proposé : son suivi doit être
    // DÉMONTRABLE, et un référent pédagogique identifié.
    { n: 19, l: "Ressources pédagogiques, vérification du suivi à distance, référent pédagogique", p: TOUS },
    { n: 20, l: "Appui à la mobilité, référent handicap, conseil de perfectionnement, supervision", p: ["app"] },
  ]},
  { c: 5, titre: "Qualification et compétences des personnels", indicators: [
    { n: 21, l: "Compétences des intervenants déterminées, mobilisées et évaluées", p: TOUS },
    { n: 22, l: "Entretien et développement des compétences des salariés", p: TOUS },
  ]},
  { c: 6, titre: "Inscription dans l'environnement professionnel", indicators: [
    { n: 23, l: "Veille légale et réglementaire sur la formation professionnelle", p: TOUS },
    { n: 24, l: "Veille sur l'évolution des compétences, des métiers et des emplois", p: TOUS },
    { n: 25, l: "Veille sur les innovations pédagogiques et technologiques", p: TOUS },
    // Le handicap quitte le critère 5 pour le critère 6 : c'est le déplacement
    // qui piège les reprises de données faites au numéro.
    { n: 26, l: "Expertises, outils et réseaux pour l'accueil et l'accompagnement du handicap", p: TOUS },
    { n: 27, l: "Conformité au référentiel en sous-traitance, traçabilité dans les contrats", p: TOUS },
    { n: 28, l: "Réseau de partenaires mobilisé pour co-construire l'ingénierie de formation", p: ["app"] },
    { n: 29, l: "Actions d'insertion professionnelle ou de poursuite d'études", p: ["app"] },
  ]},
  { c: 7, titre: "Recueil et prise en compte des appréciations et réclamations", indicators: [
    { n: 30, l: "Recueil des appréciations des parties prenantes : bénéficiaires, financeurs, équipes", p: TOUS },
    { n: 31, l: "Traitement des difficultés, réclamations et aléas survenus en prestation", p: TOUS },
    { n: 32, l: "Démarche d'amélioration continue incluant une analyse des risques qualité", p: TOUS },
    ...
    { n: 33, l: "Évaluation des contenus et des enseignements par les apprenants, distincte de la satisfaction générale", p: TOUS, nouveau: true },
  ]},
];
...
export function preparerBascule(indicateurs2019 = {}) {
  const lignes = numerosDe("v2026").map((n) => {
    ...
    return {
      n, critere: def.critere, libelle: def.l, perimetre: def.p || TOUS,
...
export function conformityRate(indicators = {}, version = "v2019", categories = null) {
  const nums = numerosDe(version).filter((n) => {
    if (!categories?.length) return true;
    // Hors périmètre = SANS OBJET. Compter un indicateur « apprentissage » pour
    // un organisme qui ne fait pas d'apprentissage plafonnerait son taux sans
    // qu'aucune action puisse le corriger.
    const p = indicateurDe(version, n)?.p;
    return !p || p.some((x) => categories.includes(x));
  });
  const vals = nums.map((n) => indicators[n]?.status || "a_verifier");
