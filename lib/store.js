...
const EMPTY = { campuses: [], deliverables: [], actions: [], visits: [], kpi: [], briefs: [], incidents: [], documents: [], partners: [], networkObjectives: [], audit: [], scenarios: [], openings: [], emailPriority: [], emailMuted: [], decisions: [], reviews: [], events: [], recoveries: [], arbitrages: [], committees: [], si: [], learners: [], enrollments: [], teachers: [], curricula: [], rooms: [], classes: [], periods: [], financeProposals: {}, curriculumProposals: {}, settings: {} };
...
function normModule(m = {}) {
  return {
    ...
    heures: num(m.heures), year: num(m.year), semester: num(m.semester),
...
export function curriculumHours(c) {
  return (c?.modules || []).reduce((a, m) => a + (m.heures || 0), 0);
}
