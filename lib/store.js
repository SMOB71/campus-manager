...
const EMPTY = { campuses: [], deliverables: [], actions: [], visits: [], kpi: [], briefs: [], incidents: [], documents: [], partners: [], networkObjectives: [], audit: [], scenarios: [], openings: [], emailPriority: [], emailMuted: [], decisions: [], reviews: [], events: [], recoveries: [], arbitrages: [], committees: [], si: [], learners: [], enrollments: [], candidates: [], contracts: [], assessments: [], grades: [], portalAccess: [], fundings: [], invoices: [], payments: [], attendanceAnchors: [], teachers: [], curricula: [], rooms: [], classes: [], periods: [], blockExemptions: [], positionnements: [], amenagements: [], suivis: [], reclamations: [], sousTraitants: [], jurySessions: [], apiKeys: [], campagnes: [], envois: [], signatures: [], mobilites: [], taxeCampagnes: [], indicateursDeclares: [], financeProposals: {}, curriculumProposals: {}, settings: {} };
