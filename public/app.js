...
// ---------- Navigation ----------
const NAV_GROUPS = ["Pilotage", "Réseau", "Performance", "Conformité", "Atelier", "Administration"];
const NAV = [
  ...
  { id: "objectifs", label: "Objectifs réseau", icon: I.target, group: "Réseau" },
  { id: "admissions", label: "Admissions", icon: I.funnel, group: "Réseau" },
  { id: "tournee", label: "Tournée", icon: I.route, group: "Réseau" },
  { id: "revues", label: "Revues mensuelles", icon: I.hist, admin: true, group: "Réseau" },
