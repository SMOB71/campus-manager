...
for ep in /api/me /api/stats /api/network /api/finance /api/finance/annual /api/performance \
          ...
          /api/learners /api/candidates /api/attendance/sheets /api/contracts /api/assessments /api/portal/access /api/teachers /api/curricula /api/rooms /api/classes /api/periods; do
  c=$(code "$BASE$ep")
